...
export default class MainL2Col extends BaseCol {
  ...
  constructor(props) {
    ...
    if (this.props.valueFormatter) {
      this.opts.valueFormatter = this.props.valueFormatter;
    }
  }
    ...
    return <div className={classnames('content-col main-content-col', this.props.colClass)}>
      <div className="col-head">
        <span className="title-content">
          ...
          <a className={classnames('col-title', this.getSortLinkClass(this.props.valueKey))}
            href="javascript:void(0)"
            onClick={this.handleSort.bind(this, this.props.valueKey)}
            >
            {this.props.title}
          </a>
        </span>
